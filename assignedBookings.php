...
$query = "SELECT b.BookingID, b.Name, b.Email, b.Phone, b.Bedrooms, b.BookingDate, b.MovingDate, b.PickupLocation, b.DropoffLocation,
          ...
          GROUP_CONCAT(e.PhoneNo SEPARATOR ',') AS EmployeePhoneNos,
          be.TimeSlot
          FROM Bookings b
          JOIN Bookings_Employees be ON b.BookingID = be.BookingID
          JOIN Employees e ON be.EmployeePhoneNo = e.PhoneNo
...
while ($row = $result->fetch_assoc()) {
    $bookings[$row['BookingID']]['Details'] = $row;
    $assignedEmployees = explode(',', $row['EmployeePhoneNos']);
    foreach ($assignedEmployees as $employeePhoneNo) {
        $bookings[$row['BookingID']]['AssignedEmployees'][$employeePhoneNo] = $employeePhoneNo;
    }
}
?>
<!DOCTYPE html>
                ...
                <div class="col-lg-6 col-md-12 mb-4">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <!-- ... [Other booking details as before] -->
                            ...
                            <p class="card-text">Assigned To: <?= htmlspecialchars($booking['Details']['AssignedEmployees']) ?></p>
                            <p class="card-text">Time Slot: <?= htmlspecialchars($booking['Details']['TimeSlot']) ?></p>
                            ...
                            <form class="update-assign-form" style="display:none;" data-booking-id="<?= $bookingID ?>">
                                <div class="employee-container">
                                    <?php foreach ($booking['AssignedEmployees'] as $employeePhoneNo) : ?>
                                ...
                                <input type="time" name="startTime" value="<?= htmlspecialchars($booking['Details']['TimeSlot']) ?>" required>
