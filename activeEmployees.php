...
$query = "SELECT PhoneNo, Name, Email, EmployeeType FROM Employees WHERE isActive = 1 AND (EmployeeType = 'Helper' OR EmployeeType = 'Driver')";
        ...
        <div class="row">
            ...
            <main class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    <h1 class="h2" id="Main-Heading">Active Employees</h1>
                </div>
                        ...
                        <?php if ($result->num_rows > 0) : ?>
                            <?php while ($row = $result->fetch_assoc()) : ?>
                                <tr>
                                    ...
                                    <td>
                                        <button type="button" class="btn btn-danger deactivateBtn" data-phoneno="<?php echo htmlspecialchars($row["PhoneNo"]); ?>">Deactivate</button>
                                    </td>
                                </tr>
                            <?php endwhile; ?>
                        <?php else : ?>
