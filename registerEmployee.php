...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $conn->prepare("INSERT INTO Employees (PhoneNo, Name, Email, EmployeeType, Password, isActive) VALUES (?, ?, ?, ?, ?, ?)");
    $stmt->bind_param("sssssi", $phoneNo, $name, $email, $employeeType, $password, $isActive);
